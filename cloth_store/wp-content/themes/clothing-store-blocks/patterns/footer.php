...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|60"},"blockGap":"0"},"background":{"backgroundImage":{"url":"http://localhost/ot-block/wp-content/themes/clothing-store-blocks/images/footer.png","id":410,"source":"file","title":"footer BG"}}},"className":"footer-widgets","layout":{"type":"constrained","contentSize":"70%"},"fontSize":"small"} -->
...
<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|70"}},"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","className":"footer-columns","layout":{"type":"default"}} -->
<div class="wp-block-group alignwide footer-columns has-heading-color has-text-color has-link-color" style="padding-top:var(--wp--preset--spacing--70)"><!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|30"}}}} -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"right":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|body-text"}}}},"textColor":"body-text","fontSize":"extra-small"} -->
<p class="has-body-text-color has-text-color has-link-color has-extra-small-font-size" style="margin-top:0;margin-bottom:0;padding-right:var(--wp--preset--spacing--40)"><?php esc_html_e('Consectetur adipiscieng elit, sed do emesdeod tempor incididunt ueseft labore eest dolorsase miagna aliqua.','clothing-store-blocks'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30"},"padding":{"right":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|body-text"}}}},"textColor":"body-text","fontSize":"extra-small"} -->
<p class="has-body-text-color has-text-color has-link-color has-extra-small-font-size" style="margin-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--40)"><?php esc_html_e('Quis ipsum suspendisse ultrsices gravidai Risus commodo viverra maecenas.','clothing-store-blocks'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-group copyright-text has-white-color has-text-color has-link-color"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white","className":"has-background-color has-text-color has-link-color has-roboto-font-family"} -->
<p class="has-background-color has-text-color has-link-color has-roboto-font-family has-white-color"><a rel="noreferrer noopener" href="https://www.ovationthemes.com/products/free-clothing-store-wordpress-theme/" target="_blank"><?php esc_html_e('Clothing Store Blocks WordPress Theme','clothing-store-blocks'); ?></a>.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white","className":"has-background-color has-text-color has-link-color has-roboto-font-family"} -->
<p class="has-background-color has-text-color has-link-color has-roboto-font-family has-white-color"><?php esc_html_e('Proudly powered by','clothing-store-blocks'); ?> <a rel="noreferrer noopener" href="https://www.ovationthemes.com/" target="_blank"><?php esc_html_e('Ovation Themes','clothing-store-blocks'); ?></a> <?php esc_html_e('and','clothing-store-blocks'); ?> <a href="https://wordpress.org"><?php esc_html_e('WordPress','clothing-store-blocks'); ?></a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
