...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"backgroundColor":"heading","className":"top-head wow fadeInDown","layout":{"type":"constrained","contentSize":"70%"}} -->
<div class="wp-block-group top-head wow fadeInDown has-heading-background-color has-background" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} -->
<div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"30%","className":"top-info"} -->
<div class="wp-block-column is-vertically-aligned-center top-info" style="flex-basis:30%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"className":"info-row","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
<div class="wp-block-group info-row"><!-- wp:group {"style":{"border":{"radius":"50%","width":"1px"}},"borderColor":"white","className":"icon-img","layout":{"type":"default"}} -->
...
<div class="wp-block-column is-vertically-aligned-center top-social" style="flex-basis:20%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"className":"info-row","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"right"}} -->
<div class="wp-block-group info-row"><!-- wp:group {"style":{"border":{"radius":"50%","width":"1px"}},"borderColor":"white","className":"icon-img","layout":{"type":"default"}} -->
<div class="wp-block-group icon-img has-border-color has-white-border-color" style="border-width:1px;border-radius:50%"><!-- wp:image {"lightbox":{"enabled":false},"id":213,"scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"center"} -->
<figure class="wp-block-image aligncenter size-full"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/socialt-1.png'); ?>" alt="" class="wp-image-213" style="object-fit:cover"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"border":{"radius":"50%","width":"1px"}},"borderColor":"white","className":"icon-img","layout":{"type":"default"}} -->
<div class="wp-block-group icon-img has-border-color has-white-border-color" style="border-width:1px;border-radius:50%"><!-- wp:image {"lightbox":{"enabled":false},"id":222,"scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"center"} -->
<figure class="wp-block-image aligncenter size-full"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/socialt-2.png'); ?>" alt="" class="wp-image-222" style="object-fit:cover"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"border":{"radius":"50%","width":"1px"}},"borderColor":"white","className":"icon-img","layout":{"type":"default"}} -->
<div class="wp-block-group icon-img has-border-color has-white-border-color" style="border-width:1px;border-radius:50%"><!-- wp:image {"lightbox":{"enabled":false},"id":221,"scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"center"} -->
<figure class="wp-block-image aligncenter size-full"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/socialt-3.png'); ?>" alt="" class="wp-image-221" style="object-fit:cover"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"border":{"radius":"50%","width":"1px"}},"borderColor":"white","className":"icon-img","layout":{"type":"default"}} -->
<div class="wp-block-group icon-img has-border-color has-white-border-color" style="border-width:1px;border-radius:50%"><!-- wp:image {"lightbox":{"enabled":false},"id":220,"scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"center"} -->
<figure class="wp-block-image aligncenter size-full"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/socialt-4.png'); ?>" alt="" class="wp-image-220" style="object-fit:cover"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-center top-login" style="flex-basis:20%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"className":"info-row","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"right"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"0","right":"0"}}},"className":"middle-header","layout":{"type":"constrained","contentSize":"70%"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"0","right":"0"}},"border":{"top":{"color":"#e5e2dd","width":"1px"}}},"className":"menu-header","layout":{"type":"constrained","contentSize":"70%"}} -->
...
<!-- wp:navigation {"textColor":"heading","overlayMenu":"always","icon":"menu","overlayBackgroundColor":"white","overlayTextColor":"primary"} --><!-- /wp:navigation --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"70%","className":"nav-block "} -->
<div class="wp-block-column is-vertically-aligned-center nav-block" style="flex-basis:70%"><!-- wp:navigation {"customTextColor":"#222222","icon":"menu","overlayBackgroundColor":"white","overlayTextColor":"primary","layout":{"type":"flex","justifyContent":"right"},"style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"500"}},"fontSize":"extra-small"} -->
