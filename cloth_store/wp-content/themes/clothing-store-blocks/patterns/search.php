...
/**
 * Title: Search
 * Slug: clothing-store-blocks/search
 * Categories: clothing-store-blocks, search
 */
?>
...
<p class="has-text-align-center has-heading-color has-text-color has-link-color"><?php esc_html_e('It seems we can’t find what you’re looking for. Perhaps searching can help.','clothing-store-blocks'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"clothing-store-blocks","tagName":"div","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->