 ...
 * Posts pagination.
 */
if ( ! function_exists( 'bb_ecommerce_store_pagination_settings' ) ) {
	function bb_ecommerce_store_pagination_type() {
		$bb_ecommerce_store_pagination_type = get_theme_mod( 'bb_ecommerce_store_pagination_settings', 'Numeric Pagination' );
		if ( $bb_ecommerce_store_pagination_type == 'Numeric Pagination' ) {
