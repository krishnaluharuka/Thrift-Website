	...
	*/
	public function site_footer_info (){
		...
		$html = '<div class="container site_info">
			...
			$html  .= '<span class="dev_info">'.sprintf( esc_html__( ' %1$s theme by aThemeArt - Proudly powered by %2$s .', 'joyas-shop' ), '<a href="'. esc_url( 'https://athemeart.com/downloads/joyas/' ) .'" target="_blank">'.esc_html_x( 'Joyas Shop', 'credit - theme', 'joyas-shop' ).'</a>',  '<a  href="'.esc_url( __( 'https://wordpress.org', 'joyas-shop' ) ).'" target="_blank" rel="nofollow">'.esc_html_x( 'WordPress', 'credit to cms', 'joyas-shop' ).'</a>' ).'</span>';
